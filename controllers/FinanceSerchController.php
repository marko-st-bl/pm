...
use app\models\FinanceSerch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * FinanceSerchController implements the CRUD actions for Finance model.
 */
class FinanceSerchController extends Controller
{
    /**
     * {@inheritdoc}
     */
